      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-black dark:from-slate-950 dark:via-purple-950 dark:to-black relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                <div className="relative w-full h-64 sm:h-80 lg:h-[500px] flex items-center justify-center">
                  {/* 3D Resume */}
                  <div className="relative w-80 h-96 sm:w-96 sm:h-[28rem] lg:w-[28rem] lg:h-[36rem]">
                    {/* Resume Container */}
                    <div 
        ...
        <div className="relative bg-background py-16 sm:py-20 lg:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Interactive 3D Snake-like Element */}
            <motion.div
            ...
            >
              <div className="relative w-96 h-96">
                ...
                >
                  {/* Snake-like wireframe structure */}
                  <svg
                    width="100%"
                    height="100%"
                    viewBox="0 0 400 400"
                  ...
                  >
                    <motion.path
                      d="M50,200 Q100,100 150,200 T250,200 Q300,300 350,200"
                      stroke="url(#gradient)"
                      strokeWidth="3"
                      fill="none"
                    ...
                    />
                    <motion.path
                      d="M50,200 Q100,300 150,200 T250,200 Q300,100 350,200"
                    ...
                    />
                    <motion.path
                      d="M50,200 Q150,150 250,200 Q200,250 150,200 Q100,150 50,200"
              ...
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                    ...
                    className="group cursor-pointer"
                  >
                    <div className={`relative w-32 h-32 ${member.borderColor} border-4 rounded-full flex items-center justify-center bg-white shadow-lg hover:shadow-xl transition-all duration-300`}>
