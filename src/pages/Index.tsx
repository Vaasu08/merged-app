          ...
          <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <motion.div
                  ...
                  <motion.span
                        className="bg-gradient-to-r from-cyan-400 via-purple-500 to-red-500 bg-clip-text text-transparent [background-size:200%_200%]"
                        animate={{
              ...
              >
                ...
                <motion.div
                  ...
                  >
                    {/* Resume Container */}
                    <div 
                      className="w-full h-full bg-white rounded-lg shadow-2xl overflow-hidden [box-shadow:0_25px_50px_-12px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.1)] [filter:drop-shadow(0_0_30px_rgba(255,255,255,0.1))]"
                    >
                      {/* Resume Content */}
